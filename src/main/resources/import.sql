...
-- COMPANIES
INSERT INTO companies(ID, SHORT_NAME, NAME, COMPANY_TYPE, ADDRESS, FK_ADVISER_ID,FK_PROJECT_ID) VALUES ('2','ADASOFT','ADA SOFTWARE', 'SRL', 'Jordan y Oquendo', '1','1')
...
INSERT INTO spaces (ID,CREATED_AT, DELETED, UPDATED_AT, TITLE, FK_PROJECT_ID, LIMIT_DATE, DESCRIPTION, FK_ADVISER_ID, SPACE_TYPE) VALUES ('3','2021-10-06 08:00:00',0,'2021-10-06 08:00:00','Parte B Corregida','1', '2021-12-06 08:00:00', 'Espacio para subir la Parte B corregida', '1', 0);
INSERT INTO spaces (ID,CREATED_AT, DELETED, UPDATED_AT, TITLE, FK_PROJECT_ID, LIMIT_DATE, DESCRIPTION, FK_ADVISER_ID, SPACE_TYPE) VALUES ('3','2021-10-06 08:00:00',0,'2021-10-06 08:00:00','Contrato','1', '2021-30-11 08:00:00', 'Espacio para subir el contrato firmado', '1', 0);
